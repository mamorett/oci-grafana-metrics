...
var IndexOfVisitor = /** @class */ (function (_super) {
    tslib_1.__extends(IndexOfVisitor, _super);
...
function indexOfNull(vector, fromIndex) {
    ...
    var i = 0;
    try {
        for (var _b = tslib_1.__values(new bit_1.BitIterator(nullBitmap, vector.data.offset + (fromIndex || 0), vector.length, nullBitmap, bit_1.getBool)), _c = _b.next(); !_c.done; _c = _b.next()) {
