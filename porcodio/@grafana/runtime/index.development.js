    ...
    Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
        ...
        this._breadcrumbs =
            maxBreadcrumbs !== undefined && maxBreadcrumbs >= 0
                ? __spread$1(this._breadcrumbs, [mergedBreadcrumb]).slice(-maxBreadcrumbs)
                : __spread$1(this._breadcrumbs, [mergedBreadcrumb]);
        this._notifyScopeListeners();
        return this;
    };
    /**
...
var Hub = /** @class */ (function () {
    ...
    Hub.prototype._invokeClient = function (method) {
        ...
        if (top && top.client && top.client[method]) {
            ...
            (_a = top.client)[method].apply(_a, __spread$1(args, [top.scope]));
        }
    };
    /**
...
function captureMessage(message, captureContext) {
    ...
    return callOnHub('captureMessage', message, level, __assign$1({ originalException: message, syntheticException: syntheticException }, context));
}
...
function toDataQueryResponse(res, queries) {
    ...
    if ((_g = res.data) === null || _g === void 0 ? void 0 : _g.results) {
        var results = res.data.results;
        var resultIDs = Object.keys(results);
        var refIDs = queries ? queries.map(function (q) { return q.refId; }) : resultIDs;
        var usedResultIDs = new Set(resultIDs);
        var data$1 = [];
        try {
        ...
        if (usedResultIDs.size) {
            try {
                for (var usedResultIDs_1 = __values(usedResultIDs), usedResultIDs_1_1 = usedResultIDs_1.next(); !usedResultIDs_1_1.done; usedResultIDs_1_1 = usedResultIDs_1.next()) {
                    var refId = usedResultIDs_1_1.value;
                    var dr = results[refId];
                    if (!dr) {
                        continue;
                    }
                ...
                try {
                    if (usedResultIDs_1_1 && !usedResultIDs_1_1.done && (_b = usedResultIDs_1.return)) _b.call(usedResultIDs_1);
                }
                finally { if (e_2) throw e_2.error; }
            }
        }
        try {
            for (var data_1 = __values(data$1), data_1_1 = data_1.next(); !data_1_1.done; data_1_1 = data_1.next()) {
                ...
                if ((_h = dr.series) === null || _h === void 0 ? void 0 : _h.length) {
                    try {
                        for (var _k = (e_4 = void 0, __values(dr.series)), _l = _k.next(); !_l.done; _l = _k.next()) {
                            var s = _l.value;
                            if (!s.refId) {
                                s.refId = dr.refId;
                            }
                ...
                if ((_j = dr.tables) === null || _j === void 0 ? void 0 : _j.length) {
                    try {
                        for (var _m = (e_5 = void 0, __values(dr.tables)), _o = _m.next(); !_o.done; _o = _m.next()) {
                            var s = _o.value;
                            if (!s.refId) {
                                s.refId = dr.refId;
                            }
                ...
                if (dr.dataframes) {
                    try {
                        for (var _p = (e_6 = void 0, __values(dr.dataframes)), _q = _p.next(); !_q.done; _q = _p.next()) {
                            var b64 = _q.value;
                            try {
...
var DataSourceWithBackend = /** @class */ (function (_super) {
    ...
    DataSourceWithBackend.prototype.query = function (request) {
        ...
        return getBackendSrv()
            ...
            return toDataQueryResponse(rsp, queries);
